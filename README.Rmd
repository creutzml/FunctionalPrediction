...
matplot(
  y = EC_mat, x = grid * 100, lwd = .5, col = gray(.25), type = "l", lty = 1,
  ylab = "N m / kg", xlab = "% of Stance Phase", main = "Extra Cushioned\nRunning Shoe"
)
matplot(
  y = NC_mat, x = grid * 100, lwd = .5, col = gray(.25), type = "l", lty = 1,
  ylab = "N m / kg", xlab = "% of Stance Phase", main = "Normal Cushioned\nRunning Shoe"
)
matplot(
  y = Dff_mat, x = grid * 100, lwd = .5, col = gray(.5), type = "l", lty = 1, ylim = c(-0.25, max(Dff_mat)),
...
par(mar = c(3.1, 2.1, 2, 1.1))
matplot(
  y = cbind(FF8_crit_value_u), x = grid * 100, col = "black", lty = c(2, 1), type = "l",
...
matplot(
  y = b, x = grid * 100, type = "n", ylim = c(min(FF8_t_band), 0.28),
  ylab = "", xlab = "", main = ""
)
...
legend(
  x = 50, y = 0.3, legend = c(
    ...
    expression(FF[t]^8)
  ), y.intersp = 1.05, bg = "white", box.col = "white",
...
grid <- seq(
  from = min(c(X_f_mat, X_m_mat), na.rm = TRUE),
...
image(hat_cov_f, col = gray(seq(0, 1, len = 32)), xlab = "Age", ylab = "Age")
box()
mtext(text = "Female", 3, line = 0.4, adj = 0, cex = cex)
image(hat_cov_m, col = gray(seq(0, 1, len = 32)), xlab = "Age", ylab = "Age")
box()
...
##
b <- confidence_band_fragm(
  x = c(hat_mu_f - hat_mu_m),
...
legend(
  x = 11, y = -0.01, legend = c(expression(paste("Estimated mean diff.")), expression(FF["frag,t"]^"2,2S")),
