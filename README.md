...
- The R script,
  [michael_analysis.R](https://github.com/creutzml/FunctionalPrediction/blob/master/Sprint_Start_Case_Study/michael_analysis.R)
  reproduces the Sprint Start case study found in **Fair Simultaneous
  Prediction and Confidence Bands for Concurrent Functional Regressions:
  Comparing Sprinters with Prosthetic versus Biological Legs** by
  [Michael L.
  Creutzinger](https://www.linkedin.com/in/michaellcreutzinger/),
